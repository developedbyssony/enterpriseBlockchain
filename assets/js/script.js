...
asdasd.from('.sc_prove [class*="bar_"]',{width:0})
...
let possiiWidth = $(".sc_possibility .slide_sub_wrap").width();
...
service1.addLabel("a").to(".sc_service .group_hr .slide",{x:-515,duration:3},"b")
.addLabel("b").to('.sc_service .group_hr .slide',{
  x:function(){
...
prove2.from('.sc_prove.prove2 .line',{x:0})
